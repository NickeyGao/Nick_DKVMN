...
if __name__ == '__main__':
    ...
    if dataset == "assist2009_updated":
        ...
        parser.add_argument('--n_question', type=int, default=13522, help='the number of unique questions in the dataset')
        parser.add_argument('--seqlen', type=int, default=200, help='the allowed maximum length of a sequence')
        parser.add_argument('--data_dir', type=str, default='../../data/STATICS/train_modified_Final.csv', help='data directory')
